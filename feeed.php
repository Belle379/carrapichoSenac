...
<div class="gallery js-flickity"
  ...
  <!--card-->
  <?php 
        $apresentar = "SELECT * FROM tb_servicos , foto, tb_user,tb_endereco";
    ...
    <article>
      <div class="article-wrapper">
        ...
        <div class="article-body">
          ...
          <h6><?php echo $colunas['bairro'] ?></h6>
          <h6><?php echo $colunas['uf'] ?></h6>
    
          <h5><?php echo $colunas['tpProfissional'] ?>- <?php echo $colunas['tpServico'] ?></h5>
          <div class="desccard">
